{
  ...
  "url": "/support/kb/synthetic-monitoring/transactions/tutorial-record-user-journey-in-shop/test-script",
  "translationKey": "https://www.uptrends.com/support/kb/transactions/tutorial-record-user-journey-in-shop/test-script",
  "tableofcontents": false
}

The following is the unedited script generated by the transaction recorder in the exercise [Capturing the shopping cart user journey]({{< ref path="support/kb/synthetic-monitoring/transactions/tutorial-record-user-journey-in-shop/recording-your-transaction" lang="en" >}}). If you didn't make your own script using the tutorial, you can use this script to follow along in the [testing and editing]({{< ref path="support/kb/synthetic-monitoring/transactions/tutorial-record-user-journey-in-shop/testing-your-transaction" lang="en" >}}) part of the tutorial. 

To enter the script into your transaction monitor:

1.  Copy the code below.
2.  Open the {{< AppElement type="tab" >}} Steps {{< /AppElement >}} tab on your transaction monitor.
3.  Click the {{< AppElement type="button" >}} Switch to script {{< /AppElement >}} button at the top right.
4.  Paste the code into the editor.
5.  Click {{< AppElement type="button" >}}Switch to visual editor{{< /AppElement >}}.
