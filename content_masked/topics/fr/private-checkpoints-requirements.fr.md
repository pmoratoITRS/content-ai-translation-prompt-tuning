...
Voici un exemple de capacité typique si vous suivez les recommandations concernant l'installation d'un emplacement privé, avec le [matériel]([LINK_URL_2]) recommandé et deux checkpoints :
...
- Confirmer les [erreurs non confirmées]([LINK_URL_3])
...
## Exigences matérielles [ANCHOR_1]
